...
public:
    // inherit constructor
    using Mode::Mode;
    Number mode_number() const override { return Number::CTALTHOLD; }
...
protected:
    ...
    const char *name() const override { return "CTALT_HOLD"; }
    const char *name4() const override { return "CTAL"; }
...
class ModeAttackLoiter : public Mode {

public:
    // inherit constructor
    using Mode::Mode;
    Number mode_number() const override { return Number::ATLO; }
...
protected:
    ...
    const char *name() const override { return "ATCLO"; }
    const char *name4() const override { return "ATLO"; }
...
class ModeSemiAuto : public Mode {

public:
    // inherit constructor
    using Mode::Mode;
    Number mode_number() const override { return Number::SEMIAUTO; }
...
protected:
    ...
    const char *name() const override { return "SAUTO"; }
    const char *name4() const override { return "SEAU"; }
...
public:
    // inherit constructor
    using Mode::Mode;
    Number mode_number() const override { return Number::CTLOITER; }
...
protected:
    ...
    const char *name() const override { return "CTLOITER"; }
    const char *name4() const override { return "CTLO"; }
