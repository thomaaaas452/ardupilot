...
void ModeAttackLoiter::run()
{
    ...
    if (!copter.failsafe.radio) {
        ...
        if(target_x<120){
            ...
            target_roll = (160-target_x)/160 * 350;
        }
        ...
        if((target_x<180)&&(target_x>140)&&(target_y>105)&&(target_y<135))
        {
            target_pitch = -800;
        }
        else if((target_x<200)&&(target_x>120)&&(target_y>90)&&(target_y<150))
        {
            target_pitch = -400;
        }
        else{
        ...
        if(target_y < 90){
            target_climb_rate = -30.0;
        }
        else if(target_y < 120){
            target_climb_rate = -(120-target_y)/120 * 30;
        }
        else if(target_y < 150){
            target_climb_rate = -(120-target_y)/160 * 30;
        }
        else{
            target_climb_rate = 30;
        }
